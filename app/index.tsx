...
const styles = StyleSheet.create({
  ...
  card:{backgroundColor:'#fff',borderColor:'#d9e0e3',borderRadius:10,borderWidth:1,gap:8,padding:12},cardTitle:{color:'#172126',fontSize:18,fontWeight:'800'},warning:{color:'#8b3c24',fontSize:14,fontWeight:'700'},warningBox:{backgroundColor:'#fff2df',borderRadius:8,gap:8,padding:10},liveHead:{backgroundColor:'#e8eef1',paddingHorizontal:10,paddingTop:4},setTitle:{color:'#172126',fontSize:16,fontWeight:'800',textAlign:'center'},stats:{gap:8,padding:10,paddingBottom:18},undo:{backgroundColor:'#fff',borderTopColor:'#d9e0e3',borderTopWidth:1,padding:8},last:{color:'#344249',fontSize:13,fontWeight:'700',marginBottom:4},clearLink:{alignItems:'center',alignSelf:'center',justifyContent:'center',minHeight:36,paddingHorizontal:12},clearLinkText:{color:'#8c3025',fontSize:14,fontWeight:'800',textDecorationLine:'underline'},
